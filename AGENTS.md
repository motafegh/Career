...
4. `plans/90_DAY_MASTER_PLAN.md`
5. `plans/CURRENT_WEEK.md`
6. `operations/SESSION_PROTOCOL.md`
7. Current AegisLab inspected evidence and technical state
8. Other repository documents
9. Suggestions from any AI agent
...
- This repository stores direction, schedules, gates, and progress summaries.
- AegisLab stores technical code, experiments, fixtures, tests, and worklogs.
- Sentinel is an autonomous research archive and cannot generate work for this program.
