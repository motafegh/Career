...
UpgradePilot remains the **only primary learning/capability project**. JobHunter and Sentinel may continue technically without becoming parallel learning flagships.
...
- Repository capability, Ali capability, and AI contribution must remain separable.
...
Default starting points for later tailoring:

- **Junior Python/backend/automation:** UpgradePilot + JobHunter; Sentinel only when it strengthens the role story.
- **Applied AI / AI Implementation:** JobHunter + UpgradePilot + Sentinel or another verified role-specific AI artifact.
- **Junior data / data engineering:** UpgradePilot + JobHunter; Sentinel as supporting data/evaluation evidence where useful.
- **ML trainee/junior ML:** Sentinel + UpgradePilot + JobHunter.
- **AI/security:** Sentinel + UpgradePilot; JobHunter optional.

The actual vacancy controls final project selection and ordering.

## 10. Project areas and records

- [`projects/upgradepilot/`](projects/upgradepilot/) — [`CAREER_RECORD.md`](projects/upgradepilot/CAREER_RECORD.md)
- [`projects/jobhunter/`](projects/jobhunter/) — [`CAREER_RECORD.md`](projects/jobhunter/CAREER_RECORD.md)
- [`projects/sentinel/`](projects/sentinel/) — [`CAREER_RECORD.md`](projects/sentinel/CAREER_RECORD.md)
- [`projects/aegislab/`](projects/aegislab/) — [`CAREER_RECORD.md`](projects/aegislab/CAREER_RECORD.md)
- [`projects/README.md`](projects/README.md) — rules for project-specific Career areas

JobHunter's Career-side market-integration authority remains under [`../market/jobhunter/`](../market/jobhunter/README.md); its project area records only the additional portfolio role and claim boundary.
