...
description: >
  Audit whether Career-facing claims about Ali, his projects, skills, ownership, experience, metrics, readiness, or production status are actually supported. Use for CV/resume, GitHub, portfolio, LinkedIn, application, interview, or project-description claims; especially when wording such as built, owned, production-ready, expert, demonstrated, improved by X%, or similar may overstate evidence. Decompose compound sentences into atomic claims, trace each to its canonical evidence and AI-assistance boundary, and return the strongest defensible wording. Do not use for capability-depth assessment itself, market calibration, or ordinary copyediting with no factual-claim question.
